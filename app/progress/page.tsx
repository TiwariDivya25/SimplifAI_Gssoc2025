    ...
    return (
        <div className="w-full">
            ...
            <div className="px-4 py-12 mx-auto relative z-10 max-w-full">
                <div className="relative bg-gradient-to-br from-primary/10 via-purple-50/50 to-pink-50/30 
                    ...
                    <div className="bg-background w-full lg:w-1/3 rounded-2xl p-6 sm:p-10 border-4">
                        <div className="bg-background w-full rounded-2xl p-6 border-4 flex flex-col items-center justify-center gap-4 text-center">
                            <h1 className="break-words text-sm sm:text-base">{user[0].image}</h1>
                            <h1 className="font-bold text-xl sm:text-2xl truncate w-full">{user[0].name}</h1>
                            <h1 className="font-bold text-sm sm:text-lg break-words max-w-full">{user[0].email}</h1>
                            <p className="text-xs sm:text-sm break-words">Created At: {user[0].createdAt.toLocaleDateString()}</p>
                            <p className="text-xs sm:text-sm break-words">Last updated: {user[0].updatedAt.toLocaleDateString()}</p>
