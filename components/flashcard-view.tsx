...
export function FlashcardView() {
  const flashcards = [
    {
      question: "What is the main benefit of AI in education according to the document?",
      answer: "Personalization of learning experiences for individual students",
      difficulty: "easy",
    },
    {
    ...
    },
    {
      ...
      answer: "Privacy concerns and potential widening of the digital divide",
      difficulty: "hard",
    },
    {
      question: "What is one recommendation for educational institutions regarding AI tools?",
      answer: "Develop clear policies on AI tool usage",
      difficulty: "medium",
    },
  ]
      ...
      <div className="w-full max-w-2xl mb-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div
              className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(flashcards[currentCard].difficulty)} text-white`}
            >
